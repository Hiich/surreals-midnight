...
import "./SudoSwapContract.sol";
import "@openzeppelin/contracts/token/ERC721/IERC721.sol";

contract SurrealsMidnight is ERC721A, Ownable {
    ...
    address surrealsAddress;
    address surrealsSwapAddress;
    ...
    function mint(uint256 amount) external payable {
        ...
        if(SurrealsSwap(surrealsSwapAddress).sacrifices(msg.sender) > 0)
            SurrealsSwap(surrealsSwapAddress).redeemSacrifice(msg.sender, amount);
        _mint(amount);
    }
